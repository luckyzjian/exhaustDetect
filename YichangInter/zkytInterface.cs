...
[System.Web.Services.WebServiceBindingAttribute(Name = "DeviceSwapIfaceImplServiceSoapBinding", Namespace = "http://iface.server.webservice.grkj.com/")]
public partial class DeviceSwapIfaceImplServiceOther : System.Web.Services.Protocols.SoapHttpClientProtocol
{
    ...
    /// <remarks/>
    public DeviceSwapIfaceImplServiceOther()
    {
        this.Url = "http://192.168.2.1:8095/jzjczjk/services/deviceSwap";
    }
    public DeviceSwapIfaceImplServiceOther(string url)
    {
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("", RequestNamespace = "http://iface.server.webservice.grkj.com/", ResponseNamespace = "http://iface.server.webservice.grkj.com/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
                ...
                object asyncState)
    {
        return this.BeginInvoke("vmasLog", new object[] {
                    ...
                    diluteCorrect,
                    humidityCorrect,
                    diluteRatio}, callback, asyncState);
    }
                ...
                object userState)
    {
        ...
        this.InvokeAsync("vmasLog", new object[] {
                    ...
                    diluteCorrect,
                    humidityCorrect,
                    diluteRatio}, this.vmasLogOperationCompleted, userState);
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegindoubleIdleLog(string businessId, string registCode, int inspectNum, double flowHC, double flowCO, double flowCO2, double analyserO2, double oilTemperature, string rotateSpeed, System.AsyncCallback callback, object asyncState)
    {
    ...
    /// <remarks/>
    public void doubleIdleLogAsync(string businessId, string registCode, int inspectNum, double flowHC, double flowCO, double flowCO2, double analyserO2, double oilTemperature, string rotateSpeed)
    {
        this.doubleIdleLogAsync(businessId, registCode, inspectNum, flowHC, flowCO, flowCO2, analyserO2, oilTemperature, rotateSpeed, null);
    }

    /// <remarks/>
    public void doubleIdleLogAsync(string businessId, string registCode, int inspectNum, double flowHC, double flowCO, double flowCO2, double analyserO2, double oilTemperature, string rotateSpeed, object userState)
    {
    ...
    public void loadDownLogAsync(
                ...
                double speedK80)
    {
        this.loadDownLogAsync(businessId, registCode, inspectNum, calVelMaxHp, actVelMaxHp, powerPerSec, speedPerSec, actMaxPower, rotateSpeed, envirTemperature, envirAirPressure, envirHumidity, powerCorrect, corMaxPower, smokeK100, smokeK90, smokeK80, speedK100, speedK90, speedK80, null);
    }
