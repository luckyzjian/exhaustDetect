...
namespace zkytInterfaceJZ
{
    ...
    public partial class DeviceSwapIfaceImplServiceJz : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        /// <remarks/>
        public DeviceSwapIfaceImplServiceJz(string url)
        {
            if (url == "")
                this.Url = "http://192.168.3.1:8095/jzjczjk/services/deviceSwap";
            else
                this.Url = url;
        }
