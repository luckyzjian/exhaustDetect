...
namespace NeusoftUtil.WebReference {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WebCtrlCenterSoap", Namespace="http://tempuri.org/")]
    public partial class WebCtrlCenter : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebCtrlCenter() {
            this.Url = global::NeusoftUtil.Properties.Settings.Default.NeusoftUtil_WebReference_WebCtrlCenter;
        ...
        /// <remarks/>
        public void RequestAsync(string Data) {
            this.RequestAsync(Data, null);
        }
        
        /// <remarks/>
        public void RequestAsync(string Data, object userState) {
            ...
            this.InvokeAsync("Request", new object[] {
                        Data}, this.RequestOperationCompleted, userState);
        }
